...
class AppClassifier @Inject constructor() {
    ...
    private val exactMap: Map<String, AppCategory> = mapOf(
        ...
        "org.amnezia.awg" to AppCategory.VPN_PROXY,
        "app.hiddify.com" to AppCategory.VPN_PROXY,
        "ang.hiddify.com" to AppCategory.VPN_PROXY,
        "com.v2ray.ang" to AppCategory.VPN_PROXY,
        "com.v2raytun.android" to AppCategory.VPN_PROXY,
        "com.agn.v2ray" to AppCategory.VPN_PROXY,
        "com.happproxy" to AppCategory.VPN_PROXY,
